Excelente trabalho, Andrey! Conseguir vencer o erro do externally-managed-environment no Ubuntu é um rito de passagem para qualquer desenvolvedor Python. Agora que sua pipeline está extraindo dados, calculando médias e gerando o dashboard, você precisa de um README.md à altura para o seu repositório.

Aqui está um modelo completo e profissional, focado no que você construiu:
